...
export default function BillingRegister({ billing }) {
    const { handleBillingClient } = useRequest();
    const { setOpenEditBilling } = useUser();
    const [statusInputRadio, setStatusInputRadio] = useState(true);
    const [form, setForm] = useState({
        client: billing.customer_name, description: billing.description, status: billing.status, value: billing.value / 100,
        due_date: format(new Date(), 'yyyy-MM-dd'), customer_cpf: billing.customer_cpf
    });
            ...
            <div className='container-modal-billing-register'>
                <div className='modal-billing-register-title'>
                    ...
                    <div
                        ...
                        onClick={() => setOpenEditBilling(false)}
                    >
                        <img
                            src={IconClose}
                            alt='fechar'
